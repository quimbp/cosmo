...
class WinSaidin(tk.Toplevel):
  ...
  def __init__ (self,parent=None):
    ...
    ttk.Label(self.frame,text='Select date',font=font_bold,width=12).grid(row=1,column=0,columnspan=2)
    ...
    ttk.Button(self.frame,text='Cancel',      \
                          ...
                          padding=5).grid(row=5,column=3,sticky='we',padx=3)
    ttk.Button(self.frame,text='Save Locally',      \
                          command=self.download,\
                          padding=5).grid(row=5,column=4,sticky='we',padx=3)
    ttk.Button(self.frame,text='Select',        \
                          command=self.done,  \
                          padding=5).grid(row=5,column=5,sticky='we',padx=3)
