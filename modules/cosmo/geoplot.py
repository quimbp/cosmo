...
# ============================
  ...
  # ==================
    ...
    self.EDGESTYLE         = tk.StringVar()
    self.EDGEWIDTH         = tk.DoubleVar()
  ...
  # =================
    ...
    conf['EDGESTYLE'] = self.EDGESTYLE.get()
    conf['EDGEWIDTH'] = self.EDGEWIDTH.get()
    conf['FACECOLOR'] = self.FACECOLOR.get()
    conf['LINEWIDTH'] = self.LINEWIDTH.get()
    conf['LINESTYLE'] = self.LINESTYLE.get()
    conf['LINECOLOR'] = self.LINECOLOR.get()
    conf['HA'] = self.HA.get()
    conf['VA'] = self.VA.get()
  ...
  # ======================
    ...
    self.EDGESTYLE.set(conf['EDGESTYLE'])
    self.EDGEWIDTH.set(conf['EDGEWIDTH'])
    self.FACECOLOR.set(conf['FACECOLOR'])
    self.LINEWIDTH.set(conf['LINEWIDTH'])
    self.LINESTYLE.set(conf['LINESTYLE'])
    self.LINECOLOR.set(conf['LINECOLOR'])
    self.HA.set(conf['HA'])
    self.VA.set(conf['VA'])
