...
! =====================================================================
! ...
subroutine out_create (ofile,FLT)
...
err = NF90_DEF_VAR(ncId,'system_time',NF90_DOUBLE,(/odl/),odsystime)
call cdf_error(err,'Unable to define variable system_time')

err = NF90_DEF_VAR(ncId,'system_date',NF90_CHAR,(/ods,odl/),odsysdate)
call cdf_error(err,'Unable to define variable system_date')

err = NF90_DEF_VAR(ncId,'lon',NF90_REAL,(/odi,odl/),odx)
  err = NF90_PUT_ATT(odi,odx,'_FillValue',sngl(FLT%missing))

err = NF90_DEF_VAR(ncId,'lat',NF90_REAL,(/odi,odl/),ody)
  err = NF90_PUT_ATT(odi,ody,'_FillValue',sngl(FLT%missing))
...
err = NF90_DEF_VAR(ncId,'nav_time',NF90_DOUBLE,(/odi,odl/),odt)
...
! =====================================================================
! ...
subroutine out_save (FLT,kk,time)
...
call cdf_error(err,'Unable to save system_time')
...
do flo=1,FLT%n
  ...
  err = NF90_PUT_VAR(ncId,oddist,(/FLT%dist(flo)/),(/flo,kk/),(/1,1/))
